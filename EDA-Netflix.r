...
e<-length(unique(titles$movieId))
#Number of movies: 9066
#Average Number of Reviews per Movie: 11.030664019413193
#RAN one-sample Wilcoxon test as the data related to how frequently a particular movie is rated by any given user doesn’t follow a normal distribution (as shown in the figure below).
...
#The figure below shows the rating frequency on each movie—out of 9066 movies 1950 movies have been rated by users more than the average rating frequency of movie.
